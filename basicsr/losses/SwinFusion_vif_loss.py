...
'''
https://github.com/Linfeng-Tang/SwinFusion/blob/master/models/loss_vif.py
...
class SwinFusion_vif_loss(nn.Module):
    def __init__(self,loss_weight=1.0):
        super(SwinFusion_vif_loss, self).__init__()
        self.L_Grad = L_Grad()
    ...
    def forward(self, image_A, image_B, image_fused):
        ...
        return self.loss_weight * fusion_loss # , loss_gradient, loss_l1, loss_SSIM
