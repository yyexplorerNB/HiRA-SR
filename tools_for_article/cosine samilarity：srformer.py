...
from utils.utils import CalculateCosSimilarityPerLayer
calculate_rank = CalculateCosSimilarityPerLayer()
...
class PSA(nn.Module):
    ...
    def forward(self, x, mask=None):
        ...
        calculate_rank.gather(mat=attn)
...
if __name__ == '__main__':
    ...
    input_path = 'datasets/Set14/LRbicx2/monarch.png'
    net = SRFormer(
        upscale= 2,
        in_chans= 3,
        img_size= 64,
    ...
    print(f'平均相似度：{calculate_rank.get_avg_sim()}')
