...
if __name__ == '__main__': import sys;sys.path.append('./')
from tools_for_article.utils.utils import low_rank_approximation
...
class PSA(nn.Module):
    ...
    def forward(self, x, mask=None):
        ...
        attn = low_rank_approximation(attn,self.lowrank)
    ...
    def __init__(self,
        ...
        self.blocks = nn.ModuleList([
            PSA_Block(
                ...
                magnification=magnification,
                lowrank=lowrank) for i in range(depth)
        ])
...
class final_SRFormer_magnification_lowrank_approximation(nn.Module):
    r""" SRFormer
    ...
    def __init__(self,
                 ...
                 lowrank=None,
                 **kwargs):
        super(final_SRFormer_magnification_lowrank_approximation, self).__init__()
...
if __name__ == '__main__':
    net = final_SRFormer_magnification_lowrank_approximation(
        upscale= 2,
        in_chans= 3,
        img_size= 64,
        window_size= 16,
