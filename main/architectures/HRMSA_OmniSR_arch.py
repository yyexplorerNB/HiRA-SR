...
class Attention(nn.Module):
    def __init__(
        ...
        self.get_v = nn.Linear(dim, dim, bias = True)
        ...
        self.get_B_C = get_B_C(dim,self.heads)
        self.scale = dim**-0.5
    ...
    def forward(self, x):
        ...
        sim = ((self.get_attn_autocorrelation(x) @ x.transpose(-2,-1)).unsqueeze(1) # [b_,1,n,n]
                * C_q * C_k
                + B_q + B_k
